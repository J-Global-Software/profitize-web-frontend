...
export const EmailService = {
	 ...
	 */
	async sendUserConfirmation({ locale, userData, userZoomLink, managementUrl, messages, icsContent, fromEmail, toEmail }: any) {
	 ...
	 */
	async sendLecturerNotification({ userData, messages, fromEmail, toEmail }: any) {
	 ...
	 */
	async sendRescheduleUser({ locale, firstName, lastName, oldEventDate, newStart, newEnd, userZoomLink, managementUrl, messages, fromEmail, toEmail }: any) {
	 ...
	 */
	async sendCancelUser({ locale, firstName, lastName, eventDate, messages, fromEmail, toEmail }: any) {
