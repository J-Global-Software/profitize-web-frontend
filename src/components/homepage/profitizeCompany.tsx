			...
			<main>
				<section className="py-10 lg:py-16">
					<div className="max-w-[1000px] mx-auto px-6">
						<div className="white-paper-border bg-white p-8 md:p-12 lg:p-16 rounded-3xl border border-gray-100 shadow-soft-xl relative overflow-hidden">
							...
							<div className="relative z-10 mb-8 text-center">
								<span className="text-[10px] font-extrabold uppercase tracking-[0.4em] text-primary mb-3 block">Strategic Roadmap</span>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 text-left mb-10 relative z-10">
								<FeatureCard icon="auto_awesome" title="Free Coaching" description="High-level assessments to unlock hidden capital efficiency in your current operational structures." />
								<FeatureCard icon="language" title="Bilingual Workshops" description="Global strategy deployment seminars delivered in English and Japanese for international teams." />
							</div>

							{/* Buttons */}
							<div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
								<button className="w-full sm:w-auto bg-primary text-white text-[10px] font-bold px-10 py-4 rounded-full hover:bg-blue-700 transition-all uppercase tracking-widest shadow-md">Book Coaching</button>
