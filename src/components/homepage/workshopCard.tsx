...
// Define the shape of the workshop object
type Workshop = {
	key: string;
};

// Define the type for the translation function 't'
// next-intl doesn't export a simple 'TFunction' type like i18next,
// so we define a standard signature for it.
